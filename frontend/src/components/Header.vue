                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        >
                            <li v-for="asset in assets" :key="asset">
                                <router-link
                                    @click="setSymbol(asset.symbol)"
                                    to="/"
                                    class="dropdown-item"
                                    >{{ asset.symbol }}</router-link
                                >
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        >
                            ...
                            <li>
                                <router-link class="dropdown-item" to="lock"
                                    >Lock</router-link
                                >
                            </li>
                            <li>
                            ...
                            <li>
                                <router-link class="dropdown-item" to="404"
                                    >404</router-link
                                >
                            </li>
                        </ul>
...
export default {
    computed: {
        ...mapState("auth", ["me"]),
        ...mapState("exchange", ["assets"]),
    },
    methods: {
        ...mapActions(["toggleDarkTheme"]),
        ...mapActions("exchange", ["setSymbol"]),
        signOut() {
            this.$store
