                ...
                <div class="row">
                  <div class="col-lg-4">
                    <ul class="settings-nav nav nav-pills nav-tabs">
                      <li v-for="balance in account.balances" :key="balance" class="nav-item">
                        <a
                            href="#"
                        ...
                        >
                          <div class="d-flex">
                            <img :src="`https://cryptoicon-api.vercel.app/api/icon/${balance.asset.toLowerCase()}`" :alt="balance.asset"/>
                            <div>
                              <h2>{{ balance.asset }}</h2>
                              <p>Bitcoin</p>
                            </div>
                          ...
                          <div>
                            <h3>{{ balance.free }}</h3>
                            <p class="text-end">
                              <i class="icon ion-md-lock"></i> {{ balance.locked }}
                            </p>
                          </div>
                        </a>
                      </li>
...
export default {
  mounted() {
    this.$store.dispatch("exchange/getAccount")
  },
  computed: {
    ...mapState('auth', [
      'me',
