...
declare namespace Components {
    namespace Schemas {
        export interface Asset {
            ...
            name: string;
            icon: string;
            price: string; // decimal ^-?\d{0,62}(?:\.\d{0,2})?$
            priceChange: string;
        }
        ...
        export interface PortfolioAsset {
            ...
            portfolio: Portfolio;
            asset: Asset;
            amount: string; // decimal ^-?\d{0,62}(?:\.\d{0,2})?$
            value: string; // decimal ^-?\d{0,62}(?:\.\d{0,2})?$
            buyAmount: string; // decimal ^-?\d{0,62}(?:\.\d{0,2})?$
            avgCost: string; // decimal ^-?\d{0,62}(?:\.\d{0,2})?$
            sellAmount: string; // decimal ^-?\d{0,62}(?:\.\d{0,2})?$
            avgCharge: string; // decimal ^-?\d{0,62}(?:\.\d{0,2})?$
            realizedPnl: string; // decimal ^-?\d{0,62}(?:\.\d{0,2})?$
            unrealizedPnl: string; // decimal ^-?\d{0,62}(?:\.\d{0,2})?$
            percentage: number;
            createdAt: string; // date-time
            updatedAt: string; // date-time
        }
